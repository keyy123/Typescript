...
var Family = /** @class */ (function () {
    function Family(name) {
        var _this = this;
        this.greet = function () {
            console.log("Good Morning ".concat(_this.familyName));
        };
        this.familyName = name;
    }
    return Family;
}());
var Bloodline = /** @class */ (function (_super) {
    __extends(Bloodline, _super);
    function Bloodline(className) {
        return _super.call(this, className) || this;
    }
    Bloodline.prototype.fightingSpirit = function () {
        console.log("Keep fighting ".concat(this.familyName));
    };
    return Bloodline;
}(Family));
var Kheyyon = new Family("Parker");
console.log(Kheyyon);
Kheyyon.greet();
var genes = new Bloodline("Fighter");
